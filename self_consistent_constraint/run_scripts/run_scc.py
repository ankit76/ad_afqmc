...
# For saving.
tmpdir = f'/projects/bcdd/shufay/hubbard_tri/self_consistent_constraint/{trs_tag}/{dm_tag}/{nx}x{ny}/{bc}/U={U}/{init_trial}/'
...
conv = run_scc(
        comm, U, nx, ny, n_elec, options, bc=bc, run_cpmc=run_cpmc, 
        proj_trs=proj_trs, set_e_estimate=set_e_estimate, init_trial=init_trial,
        tmpdir=tmpdir, filename=filename, approx_dm_pure=approx_dm_pure,
