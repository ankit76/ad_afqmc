...
@partial(jit, static_argnums=(3,4))
def _block_scan(prop_data, x, ham_data, propagator, trial):
...
@partial(jit, static_argnums=(3,4))
def _sr_block_scan(prop_data, x, ham_data, propagator, trial):
...
def propagate_phaseless(ham, ham_data, propagator, prop_data, trial):
  def _block_scan_wrapper(x, y): return _block_scan(x, y, ham_data, propagator, trial)
