...
if __name__ == '__main__':
    ...
    # Add noise to spin-mixing blocks.
    integrals_g["h1"][: n_sites, n_sites :] = np.random.random((n_sites, n_sites))
    integrals_g["h1"][n_sites :, : n_sites] = integrals_g["h1"][: n_sites, n_sites :].copy().T
    np.testing.assert_allclose(integrals_g["h1"], integrals_g["h1"].T)
