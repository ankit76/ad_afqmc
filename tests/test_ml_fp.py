...
from trot.meas.ucisd import energy_kernel_uw_rh, slice_meas_ctx_chol
from trot.trial.ucisd import slice_trial_level
...
def test_ml_fp():
    ...
    ## Truncation 2
    level2 = TmpLevelSpec(norb_keep=None, nchol_keep=None)
    p2 = make_level_pack(
        ham_data=ham_data,
        meas_ctx=meas_ctx,
        trial_data=trial_data,
