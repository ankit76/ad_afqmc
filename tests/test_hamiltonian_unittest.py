...
class TestHamiltonian(unittest.TestCase):
    ...
    def test_rot_ham_g(self):
        ...
        self.assertTrue(rot_ham["rot_h1"].shape == (nelec_sp[0] + nelec_sp[1], 2 * norb))
        self.assertTrue(rot_ham["rot_chol"].shape == (nchol, nelec_sp[0] + nelec_sp[1], 2 * norb))
    ...
    def test_rot_ham_noci(self):
        ...
        self.assertTrue(rot_ham["rot_chol"][0].shape == (ndets, nchol, nelec_sp[0], norb))
        self.assertTrue(rot_ham["rot_chol"][1].shape == (ndets, nchol, nelec_sp[1], norb))
